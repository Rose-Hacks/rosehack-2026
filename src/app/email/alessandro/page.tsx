            ...
            <tr>
              <td style="text-align: right; padding-right: 65px; padding-bottom: 65px;">
                <a href="https://www.linkedin.com/company/rosehack/" target="_blank" style="text-decoration: none; margin-right: 3px;">
                  <img src="https://www.rosehack.com/email/linkedin.webp" alt="linkedin icon" width="15" height="15" style="display: inline-block; vertical-align: middle;" />
                </a>
                <a href="https://www.instagram.com/rosehackucr/" target="_blank" style="text-decoration: none; margin-right: 3px;">
                  <img src="https://www.rosehack.com/email/instagram.webp" alt="instagram icon" width="15" height="15" style="display: inline-block; vertical-align: middle;" />
                </a>
                <a href="https://www.rosehack.com/" target="_blank" style="text-decoration: none; margin-right: 3px;">
                  <img src="https://www.rosehack.com/email/website.webp" alt="website icon" width="15" height="15" style="display: inline-block; vertical-align: middle;" />
                </a>
                <a href="https://x.com/rosehackucr" target="_blank" style="text-decoration: none;">
                  <img src="https://www.rosehack.com/email/x.webp" alt="x icon" width="10" height="10" style="display: inline-block; vertical-align: middle; margin-bottom: 3px;" />
                </a>
              </td>
            </tr>
          </tbody>
